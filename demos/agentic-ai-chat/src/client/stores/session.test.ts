...
describe("useSessionStore", () => {
  ...
  it("stores the verified identity and administrator role returned by the API", async () => {
    vi.stubGlobal(
      "fetch",
      vi
        .fn()
  ...
  it("stores isAdmin true for the configured administrator identity", async () => {
    vi.stubGlobal(
      "fetch",
      vi
        .fn()
