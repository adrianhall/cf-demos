...
- **Worker logs:** Workers & Pages > `agentic-chat` > Logs (`chat_created`, `chat_connected`, `chat_route_changed`, `chat_deleted`, `transcription_completed`, `admin_user_metadata_updated`, `chat_file_downloaded`, `egress_gateway_decision` entries).
