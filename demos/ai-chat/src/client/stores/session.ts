 ...
 * `/api/chat` (added in a later phase) also depends on this identity remaining valid: a session
 * that expires mid-conversation surfaces as a `401` from that endpoint, not from this store —
 * see docs/05-AI-CHAT.md, Access Model.
 */
