 ...
 * mock object, instead of only reachable through Vue's own watcher-scheduling timing, where a
 * disposed effect scope never re-invokes an already-scheduled callback and the null branch can
 * therefore never actually be observed via component mounting.
 */
